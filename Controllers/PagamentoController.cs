...
namespace ProjetoMercado.Controllers
{
    public class PagamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PagamentoId,FormaPagamento")] Pagamento pagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PagamentoId,FormaPagamento")] Pagamento pagamento)
        {
