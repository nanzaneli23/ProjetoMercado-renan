...
namespace ProjetoMercado.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FornecedorId,CnpjFornecedor,NomeFornecedor")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FornecedorId,CnpjFornecedor,NomeFornecedor")] Fornecedor fornecedor)
        {
