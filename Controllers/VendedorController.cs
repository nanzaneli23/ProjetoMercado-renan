...
namespace ProjetoMercado.Controllers
{
    public class VendedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VendedorId,NomeVendedor,NumeroDoCaixa")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendedorId,NomeVendedor,NumeroDoCaixa")] Vendedor vendedor)
        {
