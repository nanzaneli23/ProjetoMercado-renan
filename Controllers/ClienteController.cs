...
namespace ProjetoMercado.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,NomeCliente,TelefoneCliente,CPFCliente,NumeroDoCartao")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,NomeCliente,TelefoneCliente,CPFCliente,NumeroDoCartao")] Cliente cliente)
        {
